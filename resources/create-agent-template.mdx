...
<Warning>
  After creating an agent in the app and importing it into the template, open the agent page in the app, go to **Provider Info**, paste the generated provider public address, and save it. Use the public provider address printed by the CLI, not the provider secret key.
</Warning>
